...
- **Database:** SQLite (Local Development) / Neon PostgreSQL (Production)
...
CLOUDINARY_CLOUD_NAME=yru5zncu
CLOUDINARY_API_KEY=441669957591579
CLOUDINARY_API_SECRET=Ymf5__jKFT5cKmGAIxWHQjJG1XY
```
